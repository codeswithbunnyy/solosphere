...
` + ee + "}",
        ...
        Pi.define("edit", Hs.exports = function(e, t, r) {
            ...
            function x(R) {
                ...
                var C = function(U) {
                    ...
                    R(!1)) : U.data === "WF_third_party_cookies_supported" && (w(L, C),
                    R(!0))
                };
                L.onerror = function() {
                    w(L, C),
    ...
    var Mu = c((ok,Fu)=>{
        var qu = Ee(), Wi = Cu(), Ru = qu.process, Lu = qu.Deno, Nu = Ru && Ru.versions || Lu && Lu.version, Pu = Nu && Nu.v8, ze, fn;
        Pu && (ze = Pu.split("."),
    ...
    var Uc = c((Pk,Vc)=>{
        var QT = Lc(), Gc = Ee(), uo = je(), ZT = Bt(), JT = gn(), co = yt(), lo = pn(), eI = so(), tI = vn(), Fc = "Object already initialized", po = Gc.TypeError, rI = Gc.WeakMap, hn, Or, En, nI = function(e) {
    ...
    var Le, Sw, xw, Cw, Rw, Lw, Nw, Pw, qw, Fw, Mw, Kf, Dw, Yf, $f = he(()=>{
        ...
        De();
        Le = ue(jt()),
        {IX2_SESSION_INITIALIZED: Sw, IX2_SESSION_STARTED: xw, IX2_TEST_FRAME_RENDERED: Cw, IX2_SESSION_STOPPED: Rw, IX2_EVENT_LISTENER_ADDED: Lw, IX2_EVENT_STATE_CHANGED: Nw, IX2_ANIMATION_FRAME_CHANGED: Pw, IX2_ACTION_LIST_PLAYBACK_CHANGED: qw, IX2_VIEWPORT_WIDTH_CHANGED: Fw, IX2_MEDIA_QUERIES_DEFINED: Mw} = Te,
        Kf = {
            active: !1,
            tick: 0,
            eventListeners: [],
        ...
        function kL(e, t, r, n) {
            ...
            for (; ++i < o; ) {
                ...
                if (a && s[2]) {
                    ...
                    if (n)
                        var d = n(f, v, u, e, t, g);
                    if (!(d === void 0 ? VL(v, f, UL | BL, n, g) : d))
                        return !1
                }
            }
            return !0
    ...
    var tr, ZW, Bq, JW, kq, Hq, Wq, Xq, jq, zq, Kq, Yq, $q, Qq, Zq, ch, Jq, eF, tF, dh = he(()=>{
        ...
        tr = ue(jt());
        De();
        ({HTML_ELEMENT: ZW, PLAIN_OBJECT: Bq, ABSTRACT_NODE: JW, CONFIG_X_VALUE: kq, CONFIG_Y_VALUE: Hq, CONFIG_Z_VALUE: Wq, CONFIG_VALUE: Xq, CONFIG_X_UNIT: jq, CONFIG_Y_UNIT: zq, CONFIG_Z_UNIT: Kq, CONFIG_UNIT: Yq} = xe),
    ...
    var yh = c(Qn=>{
        ...
        Je(Of))
          ...
          , RF = xa(vh())
          , LF = xa(Eh())
          , iX = Qn.pluginMethodMap = new Map([[Sa.ActionTypeConsts.PLUGIN_LOTTIE, {
            ...CF
    ...
    function BM({element: e, actionItem: t, elementApi: r}) {
        if (Pt(t.actionTypeId))
            return Na(t.actionTypeId)(t.config);
    ...
    function YM(e, t, r, n) {
        let i = (0,
        ri.default)(t, (a,s,u)=>`${a} ${u}(${s}${jM(u, r)})`, "")
          , {setStyle: o} = n;
        Ft(e, Hr, n),
        o(e, Hr, i)
    }
    ...
    var pt, ri, Jn, ni, Kh, lM, fM, dM, pM, gM, vM, hM, EM, yM, mM, ei, Hr, Wr, ot, at, Yh, _M, bM, kh, TM, Hh, IM, ti, rr, Ot, Xr, OM, Va, $h, Ua, Ba, Qh, nr, ir, or, jr, Zh, zr, Kr, ar, sr, ur, cr, ii, AM, Jh, ka, eE, Zn, SM, CM, NM, Xh, FM, MM, GM, VM, UM, Wa, WM, XM, jM, zM, ZM, JM, eD, nE, aE = he(()=>{
        ...
        Fa();
        Kn();
        ({BACKGROUND: lM, TRANSFORM: fM, TRANSLATE_3D: dM, SCALE_3D: pM, ROTATE_X: gM, ROTATE_Y: vM, ROTATE_Z: hM, SKEW: EM, PRESERVE_3D: yM, FLEX: mM, OPACITY: ei, FILTER: Hr, FONT_VARIATION_SETTINGS: Wr, WIDTH: ot, HEIGHT: at, BACKGROUND_COLOR: Yh, BORDER_COLOR: _M, COLOR: bM, CHILDREN: kh, IMMEDIATE_CHILDREN: TM, SIBLINGS: Hh, PARENT: IM, DISPLAY: ti, WILL_CHANGE: rr, AUTO: Ot, COMMA_DELIMITER: Xr, COLON_DELIMITER: OM, BAR_DELIMITER: Va, RENDER_TRANSFORM: $h, RENDER_GENERAL: Ua, RENDER_STYLE: Ba, RENDER_PLUGIN: Qh} = xe),
        {TRANSFORM_MOVE: nr, TRANSFORM_SCALE: ir, TRANSFORM_ROTATE: or, TRANSFORM_SKEW: jr, STYLE_OPACITY: Zh, STYLE_FILTER: zr, STYLE_FONT_VARIATION: Kr, STYLE_SIZE: ar, STYLE_BACKGROUND_COLOR: sr, STYLE_BORDER: ur, STYLE_TEXT_COLOR: cr, GENERAL_DISPLAY: ii, OBJECT_VALUE: AM} = Me,
        Jh = e=>e.trim(),
        ka = Object.freeze({
            [sr]: Yh,
            [ur]: _M,
        ...
        NM = (e,t)=>e === t;
        Xh = /px/,
        FM = (e,t)=>t.reduce((r,n)=>(r[n.type] == null && (r[n.type] = WM[n.type]),
        r), e || {}),
        MM = (e,t)=>t.reduce((r,n)=>(r[n.type] == null && (r[n.type] = XM[n.type] || n.defaultValue || 0),
        r), e || {});
        GM = (e,t)=>(t && (e[t.type] = t.value || 0),
        e),
    ...
    var ai, gt, bD, TD, ID, OD, AD, wD, oi, sE, SD, xD, Xa, CD, RD, LD, ND, uE, cE = he(()=>{
        ...
        ai = ue(Mt()),
        gt = ue(jt()),
        {IX2_RAW_DATA_IMPORTED: bD, IX2_SESSION_STOPPED: TD, IX2_INSTANCE_ADDED: ID, IX2_INSTANCE_STARTED: OD, IX2_INSTANCE_REMOVED: AD, IX2_ANIMATION_FRAME_CHANGED: wD} = Te,
        {optimizeFloat: oi, applyEasing: sE, createBezierEasing: SD} = ai.IX2EasingUtils,
        {RENDER_GENERAL: xD} = xe,
        {getItemConfigByKey: Xa, getRenderType: CD, getStyleProp: RD} = ai.IX2VanillaUtils,
        LD = (e,t)=>{
    ...
    var PD, qD, FD, lE, fE = he(()=>{
        "use strict";
        De();
        ({IX2_RAW_DATA_IMPORTED: PD, IX2_SESSION_STOPPED: qD, IX2_PARAMETER_CHANGED: FD} = Te),
        lE = (e={},t)=>{
            switch (t.type) {
            case PD:
    ...
    var uy = c((JX,sy)=>{
        ...
        function L2(e) {
            if (e == null)
                return !0;
            if (I2(e) && (T2(e) || typeof e == "string" || typeof e.splice == "function" || O2(e) || w2(e) || b2(e)))
                return !e.length;
            var t = _2(e);
            if (t == S2 || t == x2)
                return !e.size;
    ...
    var Oy, tG, rG, nG, iG, oG, aG, sG, uG, cG, lG, fG, dG, pG, gG, vG, hG, EG, yG, mG, _G, bG, Qa, Za, Ja, es, TG, IG, OG, AG, si, wG, ts, ui, fr, rs, ci, ns, is, dr, os, as, li = he(()=>{
        ...
        IG = ({actionTypeId: e=Me.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: i, immediate: o, testManual: a, verbose: s, rawData: u})=>({
            type: aG,
            payload: {
                actionTypeId: e,
                actionListId: t,
    ...
    var Sy, ss, wy, SG, xG, xy, Yr, Cy = he(()=>{
        ...
        {IX2_ID_DELIMITER: wy, HTML_ELEMENT: SG, PLAIN_OBJECT: xG, WF_PAGE: xy} = xe;
    ...
    var _m = c((Cj,mm)=>{
        ...
        function CV(e) {
            ...
            return t.__actions__ = xV(e.__actions__),
    ...
    var Wm, Xm, jm, zm, rU, nU, iU, oU, aU, sU, uU, cU, lU, fU, dU, pU, gU, vU, hU, Km, Ym, EU, yU, mU, $m, _U, bU, Qm, TU, hs, Zm, Mm, Dm, Jm, Qr, IU, st, e_, OU, Ve, Qe, Zr, t_, Es, Gm, ys, AU, $r, wU, SU, xU, r_, Vm, CU, Um, RU, LU, NU, Bm, Ei, yi, km, Hm, n_, i_ = he(()=>{
        ...
        li();
        zm = ue(Mt()),
        {MOUSE_CLICK: rU, MOUSE_SECOND_CLICK: nU, MOUSE_DOWN: iU, MOUSE_UP: oU, MOUSE_OVER: aU, MOUSE_OUT: sU, DROPDOWN_CLOSE: uU, DROPDOWN_OPEN: cU, SLIDER_ACTIVE: lU, SLIDER_INACTIVE: fU, TAB_ACTIVE: dU, TAB_INACTIVE: pU, NAVBAR_CLOSE: gU, NAVBAR_OPEN: vU, MOUSE_MOVE: hU, PAGE_SCROLL_DOWN: Km, SCROLL_INTO_VIEW: Ym, SCROLL_OUT_OF_VIEW: EU, PAGE_SCROLL_UP: yU, SCROLLING_IN_VIEW: mU, PAGE_FINISH: $m, ECOMMERCE_CART_CLOSE: _U, ECOMMERCE_CART_OPEN: bU, PAGE_START: Qm, PAGE_SCROLL: TU} = Ye,
        hs = "COMPONENT_ACTIVE",
        ...
        n_ = {
            ...
            [hU]: {
                ...
                handler: ({store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: i},o={
                    ...
                    case nt.PAGE:
                        {
                            let {scrollLeft: R, scrollTop: L, scrollWidth: C, scrollHeight: U} = $r();
    ...
    function Oi({store: e, rawData: t, allowEvents: r, testManual: n}) {
        ...
        r && (lB(e),
        oB(),
        e.getState().ixSession.hasDefinedMediaQueries && JU(e)),
        e.dispatch(Ja()),
        aB(e, n))
    }
    function oB() {
    ...
    function aB(e, t) {
        let r = n=>{
            ...
            t ? eB(e, r) : requestAnimationFrame(r))
        }
        ;
    ...
    function uB({store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: i, actionListId: o, parameterGroup: a, smoothing: s, restingValue: u}) {
    ...
    function Os(e) {
        let {store: t, computedStyle: r, ...n} = e, {element: i, actionItem: o, immediate: a, pluginInstance: s, continuous: u, restingValue: f, eventId: v} = n, g = !u, d = MU(), {ixElements: h, ixSession: T, ixData: _} = t.getState(), A = FU(h, i), {refState: y} = h[A] || {}, x = ls(i), w = T.reducedMotion && Wo[o.actionTypeId], R;
        if (w && u)
    ...
    var s_, vt, u_, c_, l_, f_, gr, d_, mi, PU, _s, bs, _i, p_, qU, o_, bi, FU, Ts, Dt, MU, DU, g_, GU, VU, UU, BU, kU, HU, Ti, WU, XU, jU, zU, KU, Ii, Is, YU, a_, $U, QU, fB, pB, gB, vB, ms = he(()=>{
        ...
        PU = Object.keys(bn),
        _s = e=>PU.includes(e),
        {COLON_DELIMITER: bs, BOUNDARY_SELECTOR: _i, HTML_ELEMENT: p_, RENDER_GENERAL: qU, W_MOD_IX: o_} = xe,
        {getAffectedElements: bi, getElementId: FU, getDestinationValues: Ts, observeStore: Dt, getInstanceId: MU, renderHTMLElement: DU, clearAllStyles: g_, getMaxDurationItemIndex: GU, getComputedStyle: VU, getInstanceOrigin: UU, reduceListToGroup: BU, shouldNamespaceEventParameter: kU, getNamespacedParameterId: HU, shouldAllowMediaQuery: Ti, cleanupHTMLElement: WU, clearObjectCache: XU, stringifyTarget: jU, mediaQueriesEqual: zU, shallowEqual: KU} = mi.IX2VanillaUtils,
        {isPluginType: Ii, createPluginInstance: Is, getPluginDuration: YU} = mi.IX2VanillaPlugins,
    ...
    var G_ = c(($j,D_)=>{
        ...
        At.define("navbar", D_.exports = function(e, t) {
            var r = {}, n = e.tram, i = e(window), o = e(document), a = t.debounce, s, u, f, v, g = At.env(), d = '<div class="w-nav-overlay" data-wf-ignore />', h = ".w-nav", T = "w--open", _ = "w--nav-dropdown-open", A = "w--nav-dropdown-toggle-open", y = "w--nav-dropdown-list-open", x = "w--nav-link-open", w = xB.triggers, R = e();
...
Webflow.require('ix2').init({
    "events": {
        ...
        "e-2": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "selector": ".home-work-item-link",
                "originalId": "66166908d78c752aeb5c4aec|e6795a3f-5cee-f9cf-dcff-90c65280a199",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".home-work-item-link",
        ...
        "e-4": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "selector": ".home-work-list-item",
                "originalId": "66166908d78c752aeb5c4aec|5faa997f-1a88-93bc-f1e5-4a649bb50d9f",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".home-work-list-item",
        ...
        "e-8": {
            ...
            "target": {
                ...
                "originalId": "98f7ab4c-61d8-4815-d766-823b9a5d3727",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".about-experience",
        ...
        "e-10": {
            ...
            "target": {
                "selector": ".link",
                "originalId": "23059ba0-e877-a46a-78dd-726ae9a502ce",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".link",
        ...
        "e-12": {
            ...
            "mediaQueries": ["main"],
            "target": {
                "id": "23059ba0-e877-a46a-78dd-726ae9a502de",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-14": {
            ...
            "target": {
                "selector": ".button",
                "originalId": "23059ba0-e877-a46a-78dd-726ae9a502c8",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".button",
        ...
        "e-16": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".scrolling-heading-wrap",
                "originalId": "66166908d78c752aeb5c4aec|4fbee36e-fb51-0809-d317-96132e9dfd09",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".scrolling-heading-wrap",
        ...
        "e-18": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "661b44fbbede83af292c6d0f|a0b6fcbb-df74-3330-f3a7-9453647789f2",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-20": {
            ...
            "target": {
                ...
                "originalId": "0596ff49-bae5-6d12-a12d-d650b6a8739f",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".service-item",
        ...
        "e-24": {
            ...
            "target": {
                ...
                "originalId": "661bb7afa061f7f7b26f705a|76c8e08d-4205-7088-f30b-dca4f3595ba8",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".work-item-link",
        ...
        "e-29": {
            ...
            "target": {
                "selector": ".button-2",
                "originalId": "65b5b331af1e3bb7ac9db0a0|a00881f8-d96e-3de7-033e-80863de42505",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".button-2",
        ...
        "e-33": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".pointer-item",
                "originalId": "66166908d78c752aeb5c4aec|040e46a2-2361-ada7-a99e-7a88ec532d06",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".pointer-item",
        ...
        "e-35": {
            ...
            "target": {
                "id": "66166908d78c752aeb5c4aec|e6795a3f-5cee-f9cf-dcff-90c65280a199",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-37": {
            ...
            "target": {
                ...
                "originalId": "66166908d78c752aeb5c4aec|18f97437-0179-b7e0-6d56-0ac4578b2a6b",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".testimonial-item",
        ...
        "e-39": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "23059ba0-e877-a46a-78dd-726ae9a502bc",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-41": {
            ...
            "target": {
                "selector": ".logo-image",
                "originalId": "661b44fbbede83af292c6d0f|a0b6fcbb-df74-3330-f3a7-9453647789f7",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".logo-image",
        ...
        "e-43": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "23059ba0-e877-a46a-78dd-726ae9a502bd",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-45": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "23059ba0-e877-a46a-78dd-726ae9a502c4",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-47": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "23059ba0-e877-a46a-78dd-726ae9a502cc",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
    ...
    "actionLists": {
        "a": {
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "selector": ".home-work-images-wrap",
                                "selectorGuids": ["380d0ad3-daa7-877b-1266-6c9b8ebf90f7"]
                            },
                            "xValue": 0,
                            "xUnit": "vw",
                            "yUnit": "PX",
            ...
            "createdOn": 1712848842438
        },
        "a-2": {
            "id": "a-2",
            "title": "Home Work Item Hover In",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
            ...
            "createdOn": 1712849151787
        },
        "a-4": {
            "id": "a-4",
            "title": "Home Work Item Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-4-n-2",
                    "actionTypeId": "GENERAL_DISPLAY",
        ...
        "a-3": {
            "id": "a-3",
            "title": "Home Work Item Hover In Scale Image",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-3-n",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".home-work-image",
                            "selectorGuids": ["d419599f-eb99-d63e-0fd9-62487b362973"]
                        },
                        "xValue": 1.2,
                        "yValue": 1.2,
                        "locked": true
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1712849409028
        },
        "a-5": {
            "id": "a-5",
            "title": "Home Work Item Hover Out Scale Image",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-5-n-2",
                    "actionTypeId": "TRANSFORM_SCALE",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "ed55438b-517d-fa12-69d8-350bc8c8ebb9"
                        },
                        "value": 0,
                        "unit": ""
                    }
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".link-line",
                            "selectorGuids": ["1322e6e4-e7ac-e134-37cb-555b0c7061ea"]
                        },
                        "xValue": -100,
                        "xUnit": "%",
                        "yUnit": "PX",
        ...
        "a-10": {
            "id": "a-10",
            "title": "Footer Scroll To Top Hover In",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-10-n",
                    "actionTypeId": "TRANSFORM_SCALE",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".footer-scroll-to-top-bg",
                            "selectorGuids": ["e38d3b50-fd27-1416-cf5a-edd51572d94d"]
                        },
                        "xValue": 0,
                        "yValue": 0,
                        "locked": true
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".footer-scroll-to-top",
                            "selectorGuids": ["88b47b65-fc31-a730-3620-84e9edd3fe12"]
                        },
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1713062010066
        },
        "a-11": {
            "id": "a-11",
            "title": "Footer Scroll To Top Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-11-n-2",
                    "actionTypeId": "TRANSFORM_SCALE",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".button-dot",
                            "selectorGuids": ["5d88a110-341f-eb45-4ca3-12550d4132f7"]
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
        ...
        "a-6": {
            "id": "a-6",
            "title": "Scrolling Heading Animation",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-6-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".scrolling-heading-letter-wrap-1",
                            "selectorGuids": ["d670b15c-3022-019d-2ab4-1a153a95f9b2"]
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".scrolling-heading-letter-wrap-2",
                            "selectorGuids": ["3b6564c2-63e1-5ec2-34e2-b8b111ffc62b"]
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".scrolling-heading-letter-wrap-3",
                            "selectorGuids": ["7d711235-02e0-c8e5-85b3-c3f0b060de2d"]
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".scrolling-heading-letter-wrap-4",
                            "selectorGuids": ["3e7717f5-59c5-7dae-f0aa-71698c1ea254"]
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".scrolling-heading-letter-wrap-5",
                            "selectorGuids": ["7c65b413-e0da-41dc-aa18-d65d7cb016cc"]
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".work-item-name-arrow-wrap",
                            "selectorGuids": ["e1e6cce7-a4d9-e276-57e3-f4a7172ad540"]
                        },
                        "xValue": 2.3,
                        "xUnit": "rem",
                        "yUnit": "PX",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["e1e6cce7-a4d9-e276-57e3-f4a7172ad53e"]
                        },
                        "xValue": 1.1,
                        "yValue": 1.1,
                        "locked": true
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "661bb7afa061f7f7b26f705a|19406a1f-c9fc-a366-f82d-6fef95873383"
                            },
                            "xValue": 1,
                            "yValue": 1,
                            "locked": true
        ...
        "a-19": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "66166908d78c752aeb5c4aec|618919ee-7e09-2deb-ee54-4de2c13c33ea"
                        },
                        "xValue": 1.2,
                        "yValue": 1.2,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "id": "66166908d78c752aeb5c4aec|39ccf2f7-3730-d22e-15f7-2ea8227b6e87"
                        },
                        "value": "block"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "2db0cfc2-f0cd-69c2-935b-e086f3850eda"
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "66166908d78c752aeb5c4aec|3b268f7d-aa4f-37df-2fd8-727c625af2d7"
                        },
                        "value": 0,
                        "unit": ""
                    }
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1713156857866
        },
        "a-20": {
            "id": "a-20",
            "title": "Footer Line Scrolled In",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-20-n",
                    "actionTypeId": "TRANSFORM_SCALE",
